local zones = {
	...
	['35'] = { ['x'] = -1485.11, ['y'] = -1478.58, ['z'] = 4.422}, -- Mariage
	...
	while true do
		...
		if dist <= distance then
			...
			if not notifIn then	
				...
				ESX.ShowNotification("Vous êtes dans une Zone Safe", "", "", "CHAR_BEVERLY", 0)   
			...
			if not notifOut then
				...
				ESX.ShowNotification("Vous n\'êtes plus en Zone Safe", "", "", "CHAR_BEVERLY", 0)
