...
AddEventHandler("call:callIncoming", function(job, pos, msg)
	...
	SendNotification('~h~Appuyez sur ~g~~h~E~s~  pour ~g~accepter~s~ ou ~r~~h~Y~s~ pour ~r~refusé~s~')
	PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 0)
	
	elseif work == "fire" then
	ESX.ShowAdvancedNotification('Centrale', '~b~Appel d\'urgence: 912', '~b~Identité: ~s~Inconnu\n~b~Localisation: ~s~'.. streetname.. '', "CHAR_CALL911", 1)
	SendNotification('Appuyez sur ~g~E~s~  pour ~g~accepter~s~ ou ~r~Y~s~ pour ~r~refusé~s~')
	PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 0)
	...
	elseif work == "vigne" then
		ESX.ShowAdvancedNotification('Centrale', '~b~Appel', '~b~Identité: ~s~Inconnu\n~b~Localisation: ~s~'.. streetname.. '', "CHAR_CALL911", 1)
		SendNotification('~h~Appuyez sur ~g~~h~E~s~  pour ~g~accepter~s~ ou ~r~~h~Y~s~ pour ~r~refusé~s~')
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 0)
