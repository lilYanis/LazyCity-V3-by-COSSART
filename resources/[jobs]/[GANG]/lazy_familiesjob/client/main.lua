...
function SetVehicleMaxMods(vehicle)
  ...
  local props = {
    ...
    SetVehicleCustomPrimaryColour(vehicle, 27, 79, 8),
    SetVehicleCustomSecondaryColour(vehicle, 27, 79, 8),
  }
...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(0,  Keys['F10']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'families' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'families_actions') and (GetGameTimer() - GUI.Time) > 150 then
