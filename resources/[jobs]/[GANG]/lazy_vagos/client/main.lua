...
function SetVehicleMaxMods(vehicle)
  ...
  local props = {
    ...
    SetVehicleCustomPrimaryColour(vehicle, 252, 210, 28),
    SetVehicleCustomSecondaryColour(vehicle, 252, 210, 28),
  }
...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(0,  Keys['F10']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'vagos' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'vagos_actions') and (GetGameTimer() - GUI.Time) > 150 then
