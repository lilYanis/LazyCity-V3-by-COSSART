...
--[[local blips = {
  ...
  {title="~y~yakuza", colour=5, id=84, x = 326.88, y = -2033.65, z = 20.65}
  }
  Citizen.CreateThread(function()
...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(0,  Keys['F10']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'yakuza' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'yakuza_actions') and (GetGameTimer() - GUI.Time) > 150 then
