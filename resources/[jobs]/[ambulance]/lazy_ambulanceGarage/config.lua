...
Config.CarGarageName = "Garage de voitures"
...
Config.HeliGarageName = "Garage d'hélicoptère"
...
Config.ExtraGarageName = "Accessoires de voitures"
...
Config.ExtraDraw3DText = "Appuyez sur ~g~[E]~s~ pour ~y~ouvrir le menu des ambulances~s~"		-- set your desired text here
...
Config.CarOutFromPolGar = "Vous avez pris un ~b~Vehicule~s~ de ~y~Ambulance Garage~s~!"
Config.HeliOutFromPolGar = "Vous avez pris un ~b~Helicoptere~s~ de ~y~Ambulance Helicoptere Garage~s~!"
Config.BoatOutFromPolGar = "Vous avez pris un ~b~Bateau~s~ de ~y~Ambulance Bateau Garage~s~!"
Config.VehRepNotify = "Ton ~b~vehicule~s~ est en cours de ~y~réparation~s~, patientez !"
Config.VehRepDoneNotify = "Ton ~b~vehicule~s~ a été ~y~réparé~s~!"
Config.VehCleanNotify = "Ton ~b~vehicule~s~ est en cours de ~y~nettoyage~s~, patientez !"
Config.VehCleanDoneNotify = "Ton ~b~vehicule~s~ a été ~y~nettoyé~s~!"
