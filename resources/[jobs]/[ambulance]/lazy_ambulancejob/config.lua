...
Config.AuthorizedVehicles = {
	...
	ambulance = {
		...
		{ model = 'VTU', label = 'Pompier', price = 1},
		{ model = 'VLDDSIS', label = 'Pompier', price = 1},
		{ model = 'x5om', label = 'Samu Lyon', price = 1},
		{ model = 'FSR', label = 'Pompier', price = 1},
		{ model = 'firetruk', label = 'Pompier', price = 1},
		{ model = 'vl3sm', label = 'Pompier Routier', price = 1}
	},
