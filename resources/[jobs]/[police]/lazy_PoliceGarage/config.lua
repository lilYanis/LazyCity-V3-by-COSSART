...
Config.PoliceVehicles = {
		...
		{ model = 'newvic', label = 'Mercedess Cadet LSPD'},
		{ model = '18charger', label = 'Dodge Charger LSPD'},
		{ model = '16explorer', label = 'Ford Interceptor LSPD'},
		{ model = '16taurus', label = 'Tarus LSPD'},
