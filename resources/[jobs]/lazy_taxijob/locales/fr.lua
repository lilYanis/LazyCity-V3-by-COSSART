Locales['fr'] = {
  ...
  ['cloakroom_prompt'] = 'Apppuyez sur ~INPUT_CONTEXT~ pour ouvrir le ~y~cloakroom~s~.',
  ['wear_citizen'] = 'Tenue de citoyen',
  ...
  ['spawnpoint_blocked'] = 'Un véhicule bloque le passage!',
  ...
  ['start_job'] = 'Arrêter / Reprendre les missions',
